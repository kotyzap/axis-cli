...
exports.OS13_SOURCE = exports.OS13_32BIT_PRODUCTS = void 0;
exports.normaliseModel = normaliseModel;
exports.os13ThirtyTwoBitModels = os13ThirtyTwoBitModels;
exports.upgradePath = upgradePath;
exports.osMajor = osMajor;
/**
...
exports.OS13_SOURCE = 'https://help.axis.com/en-us/axis-os';
...
const OS13_SET = new Set(exports.OS13_32BIT_PRODUCTS.flatMap(expand));
/** Every model name this list covers, expanded. Exposed so the web page can render it. */
function os13ThirtyTwoBitModels() {
 ...
 */
function upgradePath(architecture, productNumber, 
...
currentOsMajor) {
    ...
    if (arch === 'aarch64' || arch === 'arm64' || arch === 'x86_64' || arch === 'amd64')
        return 'has-path';
    const model = normaliseModel(productNumber ?? '');
    if (!model)
        return 'unknown';
    if (OS13_SET.has(model))
        return 'has-path';
